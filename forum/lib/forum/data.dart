...
class Data extends StatefulWidget {
  ...
  void createdb() {
    ...
    // ----------------------------------------------------------------
    var forum1 = Forum_Post("Renae", "forum1", "title1", "content1",
        [Tag1, Tag2], [Answer1, Answer3, Answer5]);
    var forum2 = Forum_Post("Cassie", "forum2", "title2", "content2",
        [Tag1, Tag4], [Answer2, Answer4]);
    var forum3 = Forum_Post(
        "Katelin", "forum3", "title3", "content3", [Tag3], [Answer4, Answer1]);
    var forum4 = Forum_Post(
        "Winston", "forum4", "title4", "content4", [Tag2], [Answer5, Answer3]);
    var forum5 = Forum_Post("Alastair", "forum5", "title5", "content5",
        [Tag2, Tag4], [Answer3, Answer4]);
    posts = [forum1, forum2, forum3, forum4, forum5];
    // ----------------------------------------------------------------
    Tag1.addPost(forum1);
    Tag2.addPost(forum1);
    Tag1.addPost(forum2);
